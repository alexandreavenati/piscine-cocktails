...
class CocktailNo3 extends AbstractController
{

    #[Route('/cocktail-3', name: 'cocktail-trois')]

    public function cocktailTrois()
    {
        $cocktails = [
            1 => [
                'id'            => 1,
        ...
        return $this->render('cocktail-no3.html.twig', ['cocktails' => $cocktails]);
    }
}
